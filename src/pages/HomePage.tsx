      ...
      <section className="bg-gradient-to-b from-[#0f1f33] to-[#1e3a5f]">
        <div className="mx-auto max-w-6xl px-6 pb-20 pt-16 md:pb-28 md:pt-24">
          <div className="animate-fade-up max-w-2xl">
            ...
            <p className="mb-8 max-w-xl text-[15px] leading-relaxed text-white/60">
            ...
            {[
              ...
              return (
                <div key={stat.label} className="text-center">
                  <Icon className="mx-auto mb-2 h-5 w-5 text-[#86868b]" />
                  <div className="text-2xl font-bold tracking-tight text-[#1d1d1f]">{stat.value}</div>
                  <div className="mt-0.5 text-[13px] text-[#86868b]">{stat.label}</div>
                </div>
              )
            })}
          </div>
      ...
      <section id="about" className="py-16 md:py-20">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <div className="rounded-2xl border border-[#d2d2d7]/40 bg-white p-7 transition-shadow duration-300 hover:shadow-md">
              <div className="mb-4 flex items-center gap-3">
                ...
                <h3 className="text-[17px] font-semibold text-[#1d1d1f]">Mision</h3>
              </div>
              <p className="text-[14px] leading-relaxed text-[#86868b]">{schoolInfo.mission}</p>
            </div>
            ...
            <div className="rounded-2xl border border-[#d2d2d7]/40 bg-white p-7 transition-shadow duration-300 hover:shadow-md">
              <div className="mb-4 flex items-center gap-3">
                ...
                <h3 className="text-[17px] font-semibold text-[#1d1d1f]">Vision</h3>
              </div>
              <p className="text-[14px] leading-relaxed text-[#86868b]">{schoolInfo.vision}</p>
            </div>
          </div>
        </div>
      </section>
